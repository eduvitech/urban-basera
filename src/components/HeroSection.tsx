...
const HeroSection = () => {
    ...
    return (
        <section className="relative min-h-[75vh] md:min-h-[78vh] lg:min-h-[92vh] flex items-center overflow-hidden">
            {/* Background Layer */}
            ...
            <div className="relative z-10 max-w-7xl mx-auto container-padding pt-20">
                <div className="max-w-5xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Button variant="hero" size="lg" className="text-lg px-10 py-5" onClick={() => redirectWhatsApp()}>
